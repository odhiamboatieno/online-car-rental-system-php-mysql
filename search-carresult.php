...
$sql = "SELECT id from neorent_vehicles_table where neorent_vehicles_table.VehiclesBrand=:brand and neorent_vehicles_table.FuelType=:fueltype";
...
$sql = "SELECT neorent_vehicles_table.*,neorent_vehiclebrands_table.BrandName,neorent_vehiclebrands_table.id as bid  from neorent_vehicles_table join neorent_vehiclebrands_table on neorent_vehiclebrands_table.id=neorent_vehicles_table.VehiclesBrand where neorent_vehicles_table.VehiclesBrand=:brand and neorent_vehicles_table.FuelType=:fueltype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':fueltype',$fueltype, PDO::PARAM_STR);
$query->execute();
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT neorent_vehicles_table.*,neorent_vehiclebrands_table.BrandName,neorent_vehiclebrands_table.id as bid  from neorent_vehicles_table join neorent_vehiclebrands_table on neorent_vehiclebrands_table.id=neorent_vehicles_table.VehiclesBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
