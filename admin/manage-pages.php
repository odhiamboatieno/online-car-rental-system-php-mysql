...
$sql = "UPDATE neorent_systempages_table SET detail=:pagedetails WHERE type=:pagetype";
...
<head>
	...
	<title>Lala Cabs | Admin Create Brand</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			...
			<textarea class="form-control" rows="5" cols="50" name="pgedetails" id="pgedetails" placeholder="Package Details" required>
										<?php 
$pagetype=$_GET['type'];
$sql = "SELECT detail from neorent_systempages_table where type=:pagetype";
$query = $dbh -> prepare($sql);
$query->bindParam(':pagetype',$pagetype,PDO::PARAM_STR);
$query->execute();
