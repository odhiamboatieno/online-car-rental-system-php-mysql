...
$sql="update neorent_vehicles_table set Vimage4=:vimage where id=:id";
...
<head>
	...
	<title>Lala Cabs | Admin Update Image 4</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from neorent_vehicles_table where neorent_vehicles_table.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
