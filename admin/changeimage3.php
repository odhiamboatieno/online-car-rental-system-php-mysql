...
$sql="update neorent_vehicles_table set Vimage3=:vimage where id=:id";
...
<head>
	...
	<title>Lala Cabs | Admin Update Image 3</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 from neorent_vehicles_table where neorent_vehicles_table.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
