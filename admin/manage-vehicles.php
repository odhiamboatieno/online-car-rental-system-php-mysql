...
$sql = "delete from neorent_vehicles_table  WHERE  id=:delid";
...
<head>
	...
	<title>Lala Cabs |Admin Manage Vehicles   </title>
...
<?php $sql = "SELECT neorent_vehicles_table.VehiclesTitle,neorent_vehicles_table.PlateNumber,neorent_vehiclebrands_table.BrandName,neorent_vehicles_table.PricePerDay,neorent_vehicles_table.FuelType,neorent_vehicles_table.ModelYear,neorent_vehicles_table.id from neorent_vehicles_table join neorent_vehiclebrands_table on neorent_vehiclebrands_table.id=neorent_vehicles_table.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
