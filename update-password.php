...
$email=$_SESSION['login'];
  $sql ="SELECT Password FROM neorent_users_table WHERE EmailId=:email and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update neorent_users_table set Password=:newpassword where EmailId=:email";
