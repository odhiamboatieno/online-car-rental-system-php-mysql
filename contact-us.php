...
$sql="INSERT INTO  neorent_contactusquery_table(name,EmailId,ContactNumber,Message) VALUES(:name,:email,:contactno,:message)";
...
<title>CarForYou- Odhiambo Atieno Portal</title>
<!--Bootstrap -->
